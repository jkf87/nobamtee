...
> **invariant 란?**
> 프로그래밍에서 "어떤 작업을 하든 절대 변하면 안 되는 규칙" 을 뜻합니다. 여기서는 원문의 보존 대상 토큰 (수치·날짜·고유명사·인용·영어 약어) 이 윤문본에 그대로 남아 있어야 한다는 규칙입니다. 위반한 edit 은 롤백 후 1회 재시도하고, 그래도 안 되면 그 구간은 원문 그대로 두고 `VC-SUMMARY` 의 `flags` 에 기록됩니다.
